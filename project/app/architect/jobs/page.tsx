      ...
      <div className="container mx-auto p-4 flex items-center justify-center min-h-screen">
        <Card className="w-full max-w-4xl">
          <CardHeader>
            ...
            <CardDescription>View and manage jobs for a milestone.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="rounded-md bg-yellow-50 p-3 text-sm text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400">
              {!goalId && !milestoneId
                ? "No goal ID or milestone ID provided. Please provide both in the URL parameters."
                : !goalId
                ? "No goal ID provided. Please provide a goal ID in the URL parameter."
                : "No milestone ID provided. Please provide a milestone ID in the URL parameter."}
            </div>
          </CardContent>
        </Card>
      </div>
